...
if res == 512:
	test_l2 = 0.005781
	timestamp = '20220807-193320'
	batch_size = 5
if res == 256:
	test_l2 = 0.005936
	timestamp = '20220806-124837'
if res == 128:
	test_l2 = 0.006217
	timestamp = '20220806-051957'
if res == 64:
	test_l2 = 0.008129
	timestamp = '0.008129'
if res == 32:
	test_l2 = 0.015537
	timestamp = '20220805-211926'
if res == 16:
	test_l2 = 0.032621
	timestamp = '20220805-210126'
...
dataLoss = np.loadtxt('files/lossData'+ModelInfos+'.txt')
...
F_train, U_train, _, _= readtoArray(fileName, 1, 1, 512, 512)
res = res+1
...
plt.savefig('figures/1compare'+ModelInfos+'.png',dpi=500)
...
fig.tight_layout()
plt.savefig('figures/MWT-Darcy-Forward-UP.png',dpi=500)