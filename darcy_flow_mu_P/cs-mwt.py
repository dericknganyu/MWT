...
#         decompose
        for i in range(ns-self.L):
            ...
            #print('iteration %s: x shape = %s, d shape = %s'%(i+1, x.shape, d.shape))
...
#        reconstruct            
    ...
    def wavelet_transform(self, x):
        ...
        #print('self.ec_d shape %s, self.ec_s shape = %s, xa shape = %s'%(self.ec_d.shape, self.ec_s.cshape, xa.shape))
        return d, s
