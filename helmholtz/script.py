...
resolutions = [100]#[16, 32, 64, 128, 256, 512]
batch_size =  [10]#[10, 10, 10, 10 , 10, 5]
gpu_infos =   [1]#[ 0,  0,  1,  2 , 4, 7]

for res, gpu_in, bs  in zip(resolutions, gpu_infos, batch_size):

    screen_name = 'mwt-poisson_'+str(res)#'inv_fno_'+str(res)
...
gpu_infos =   [1]#[ 0,  0,  1,  2 , 3, 7]

for res, gpu_in, bs  in zip(resolutions, gpu_infos, batch_size):

    screen_name = 'inv-mwt-poisson_'+str(res)#'inv_fno_'+str(res)
